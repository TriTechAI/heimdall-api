...
type CommentApproveRequest struct {
	ID     string `path:"id"`
	Reason string `json:"reason,optional" validate:"max=200"`
}

type CommentApproveResponse struct {
	Code      int    `json:"code"`
	Message   string `json:"message"`
	Timestamp string `json:"timestamp"`
}
...
type CommentBatchRequest struct {
	...
	Action string   `json:"action" validate:"required,options=approve|reject|spam|delete"`
	Reason string   `json:"reason,optional" validate:"max=200"`
}

type CommentBatchResponse struct {
	Code       int    `json:"code"`
	Message    string `json:"message"`
...
type CommentBatchStatusRequest struct {
	IDs    []string `json:"ids" validate:"required,min=1,max=100"`
	Status string   `json:"status" validate:"required,options=pending|approved|rejected|spam"`
}

type CommentBatchStatusResponse struct {
	Code      int                  `json:"code"`
	Message   string               `json:"message"`
...
type CommentListRequest struct {
	PostID      string `form:"postId,optional"`
	ParentID    string `form:"parentId,optional"`
	AuthorEmail string `form:"authorEmail,optional"`
	AuthorIP    string `form:"authorIP,optional"`
	Status      string `form:"status,optional,options=pending|approved|rejected|spam"`
	Visibility  string `form:"visibility,optional,options=public|private"`
	Type        string `form:"type,optional,options=comment|reply"`
	Level       int    `form:"level,optional,range=[0:3]"`
	Keyword     string `form:"keyword,optional"`
	StartTime   string `form:"startTime,optional"`
	EndTime     string `form:"endTime,optional"`
	SortBy      string `form:"sortBy,optional,default=createdAt,options=createdAt|updatedAt|approvedAt|replyCount|likeCount|level"`
	SortDesc    bool   `form:"sortDesc,optional,default=true"`
	Page        int    `form:"page,optional,default=1,range=[1:]"`
	Limit       int    `form:"limit,optional,default=20,range=[1:100]"`
}
...
type CommentRejectResponse struct {
	Code      int    `json:"code"`
	Message   string `json:"message"`
	Timestamp string `json:"timestamp"`
}
...
type CommentSpamRequest struct {
	ID     string `path:"id"`
	Reason string `json:"reason,optional" validate:"max=200"`
}

type CommentSpamResponse struct {
	Code      int    `json:"code"`
	Message   string `json:"message"`
	Timestamp string `json:"timestamp"`
}
...
type CommentUpdateRequest struct {
	ID            string `path:"id"`
	Content       string `json:"content,optional" validate:"min=1,max=1000"`
	AuthorName    string `json:"authorName,optional" validate:"min=1,max=100"`
	AuthorEmail   string `json:"authorEmail,optional" validate:"email,max=255"`
	AuthorWebsite string `json:"authorWebsite,optional" validate:"url,max=255"`
	Status        string `json:"status,optional,options=pending|approved|rejected|spam"`
	Visibility    string `json:"visibility,optional,options=public|private"`
}
...
type PostBatchStatusRequest struct {
	IDs    []string `json:"ids" validate:"required,min=1,max=100"`
	Status string   `json:"status" validate:"required,options=draft|published|archived"`
}

type PostBatchStatusResponse struct {
	Code      int                  `json:"code"`
	Message   string               `json:"message"`
	Data      BatchOperationResult `json:"data"`
	Timestamp string               `json:"timestamp"`
...
type TagAllItem struct {
	ID   string `json:"id"`
	Name string `json:"name"`
	Slug string `json:"slug"`
}

type TagAllRequest struct {
}

type TagAllResponse struct {
	Code      int          `json:"code"`
	Message   string       `json:"message"`
	Data      []TagAllItem `json:"data"`
	Timestamp string       `json:"timestamp"`
}

type TagBatchDeleteRequest struct {
	IDs []string `json:"ids" validate:"required,min=1,max=50"`
}

type TagBatchDeleteResponse struct {
	Code      int                  `json:"code"`
	Message   string               `json:"message"`
	Data      BatchOperationResult `json:"data"`
	Timestamp string               `json:"timestamp"`
...
type TagSearchRequest struct {
	Keyword string `form:"keyword" validate:"required,min=1,max=50"`
	Limit   int    `form:"limit,default=10,range=[1:50]"`
}

type TagSearchResponse struct {
	Code      int             `json:"code"`
	Message   string          `json:"message"`
	Data      []TagSearchItem `json:"data"`
	Timestamp string          `json:"timestamp"`
}
